...
-- Emmet
-- vim.g.user_emmet_leader_key='<A>' -- use Alt and comma to complete emmet snippet
-- vim.g.user_emmet_mode='i' -- only enable emmet in INSERT mode
